...
def test_add_qso_1(capsys):  # or use "capfd" for fd-level
    ...
    assert captured.out=='7,-106.579229,32.380401,-94.6250,38.6458,2023/01/31 11:47:00,7,14057.6,KTEST'
...
def test_add_qso_2(capsys):  # or use "capfd" for fd-level
    ...
    captured_fields = captured.out.split(",")
    assert captured.out=='7,-106.578838,32.382328,-97.0957613946923,30.0488933199194,2023/01/29 17:32,0,14058.3,KF9RX'
